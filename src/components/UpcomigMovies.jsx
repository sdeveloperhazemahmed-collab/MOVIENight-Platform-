  ...
  return (
    <>
      <div className="flex justify-start flex-wrap gap-[26px] w-[96%] h-[1790px] ml-[2%] overflow-x-auto scroll-smooth scrollBar">
        {movies.map(movie => (
          movie.poster_path && (
            <div className="mx-[6px] my-[10px] w-[272px] h-[405px] bg-[var(--light-color)] rounded-lg flex-shrink-0 hover:scale-[1.05] transition-all duration-300 cursor-pointer" key={movie.id} onClick={() => navigate(`/movie/${movie.id}`)}>
